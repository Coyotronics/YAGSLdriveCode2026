...
public class RobotContainer {
        ...
        final edu.wpi.first.wpilibj2.command.button.CommandGenericHID keyboard = new edu.wpi.first.wpilibj2.command.button.CommandGenericHID(
                        1);
        ...
        {
                hood.setDefaultCommand(hood.setAngle(edu.wpi.first.units.Units.Degrees.of(12)));
        }
        ...
        private void configureBindings() {
                ...
                // --- Hood Controls (D-pad) ---
                driverXbox.povUp().onTrue(hood.runTo(
                                edu.wpi.first.units.Units.Degrees.of(frc.robot.Constants.HoodConstants.MAX_ANGLE_DEG)));
                driverXbox.povDown().onTrue(hood.runTo(
                                edu.wpi.first.units.Units.Degrees.of(frc.robot.Constants.HoodConstants.MIN_ANGLE_DEG)));
                driverXbox.povLeft().onTrue(hood.runTo(
                                edu.wpi.first.units.Units.Degrees
                                                .of(frc.robot.Constants.HoodConstants.MAX_ANGLE_DEG / 2.0)));

                keyboard.button(5).onTrue(hood.runTo(edu.wpi.first.units.Units.Degrees.of(0)));
                keyboard.button(6).onTrue(hood.runTo(edu.wpi.first.units.Units.Degrees.of(30)));
                keyboard.button(7).onTrue(hood.runTo(edu.wpi.first.units.Units.Degrees.of(60)));
                keyboard.button(8).onTrue(hood.runTo(edu.wpi.first.units.Units.Degrees.of(90)));
        }
